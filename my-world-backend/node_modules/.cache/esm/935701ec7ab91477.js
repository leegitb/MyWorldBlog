let Joi,User;_7ab‍.x([["register",()=>register],["login",()=>login],["check",()=>check],["logout",()=>logout]]);_7ab‍.w("@hapi/joi",[["default",["Joi"],function(v){Joi=v}]]);_7ab‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);
